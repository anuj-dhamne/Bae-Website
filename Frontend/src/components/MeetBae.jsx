    ...
    return (
        <div className="flex flex-col overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row w-full">
                ...
                <div className="w-full lg:w-1/2 bg-[#FFE4EB] flex items-center justify-center py-8 sm:py-12">
                    <img
                        src={modelGif}
                        alt="Fashion Model"
                        className="max-h-[400px] sm:max-h-[600px] lg:max-h-[800px] w-auto object-contain"
                    />
                </div>
            </div>
